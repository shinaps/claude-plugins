...
import type { SummaryJson, ResultJson, PrMeta } from './types.js'
import { createShiki } from './shiki-bundle.js'
import { parseDiff } from './diff-parser.js'
import { buildHtml } from './template.js'
import { startServer, type SourcesMap } from './server.js'
...
async function main(): Promise<void> {
  ...
  process.stderr.write(`[review-diff] highlighting ${lineCount} diff lines...\n`)

  const shiki = createShiki()
  const files = parseDiff(diffText, shiki)

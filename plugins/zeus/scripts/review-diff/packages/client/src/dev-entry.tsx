...
// CSS は `import './styles.css'` で読み込み、Vite に <style> 注入と HMR を委ねる。
// 本番ビルドでは build.mjs が styles.css を読み、template.ts の __CSS_STRING__ に
// define で注入するため、dev / 本番で見た目は完全に一致する。
